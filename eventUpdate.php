...
<div class="tab-content">
        ...
        if (mysqli_num_rows($saturdayEvents) > 0) {
            while ($event = mysqli_fetch_assoc($saturdayEvents)) {
                echo '<div class="col-md-6">
                          <div class="bg-dark rounded text-center py-5 px-3">
                              <div class="card-body">
                                  <h5 class="text-uppercase text-light mb-03">' . $event['event'] . '</h5>
                                  <p class="text-light mb-03">Venue: ' . $event['venue'] . '</p>
                                  <p class="text-light mb-03">Time: ' . $event['time'] . '</p>
                              </div>
                          </div>
                      </div>';
            }
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Saturday</h5>
                      </div>
                  </div>';
        }
        ?>
    ...
    <div id="tab-2" class="tab-pane fade">
        ...
        if (mysqli_num_rows($sundayEvents) > 0) {
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Sunday</h5>
                      </div>
                  </div>';
        }
        ?>               
    ...
    <div id="tab-3" class="tab-pane fade">
        ...
        if (mysqli_num_rows($mondayEvents) > 0) {
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Monday</h5>
                      </div>
                  </div>';
        }
        ?>
    ...
    <div id="tab-4" class="tab-pane fade">
        ...
        if (mysqli_num_rows($tuesdayEvents) > 0) {
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Tuesday</h5>
                      </div>
                  </div>';
        }
        ?>       
    ...
    <div id="tab-5" class="tab-pane fade">
        ...
        if (mysqli_num_rows($wednesdayEvents) > 0) {
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Wednesday</h5>
                      </div>
                  </div>';
        }
        ?>
    ...
    <div id="tab-6" class="tab-pane fade">
        ...
        if (mysqli_num_rows($thursdayEvents) > 0) {
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Thursday</h5>
                      </div>
                  </div>';
        }
        ?>
    ...
    <div id="tab-7" class="tab-pane fade">
        ...
        if (mysqli_num_rows($fridayEvents) > 0) {
            ...
            echo '<div class="col-md-12">
                      <div class="bg-dark rounded text-center py-5">
                          <h5 class="text-uppercase text-light mb-03">No events on Friday</h5>
                      </div>
                  </div>';
        }
        ?>
