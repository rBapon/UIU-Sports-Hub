...
if (isset($_POST["cancel_booking"])) {
    ...
    // Check if booking exists for the provided user ID and football item
    $sqlCheckBooking = "SELECT quantity FROM booking_list WHERE item = 'football' AND id = ?";
    ...
    if (mysqli_stmt_num_rows($stmtCheckBooking) > 0) {
        ...
        $sqlDeleteBooking = "DELETE FROM booking_list WHERE item = 'football' AND id = ?";
        ...
        $sqlUpdateInventory = "UPDATE inventory SET football = football + ?";
...
<head>
    ...
    <title>Cancel Football Booking</title>
    <style>
        body {
