...
if (isset($_POST['save_changes'])) {
    ...
    $updateQuery = "UPDATE inventory SET badminton='$badminton'"; 
...
<div class="inventory-form">
    ...
    <form method="post" action="editbadminton.php">
        <div class="form-group">
            <label for="badminton">Badminton:</label>
            <input type="number" name="badminton" id="badminton" value="<?php echo $row['badminton']; ?>">
        </div>
