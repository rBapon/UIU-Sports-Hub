...
if (isset($_POST['save_changes'])) {
    ...
    $updateQuery = "UPDATE inventory SET football='$football'"; 
...
<div class="inventory-form">
    ...
    <form method="post" action="editfootball.php">
        <div class="form-group">
            <label for="football">Football:</label>
            <input type="number" name="football" id="football" value="<?php echo $row['football']; ?>">
        </div>
