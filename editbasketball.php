...
if (isset($_POST['save_changes'])) {
    ...
    $updateQuery = "UPDATE inventory SET basketball='$basketball'"; 
...
<div class="inventory-form">
    ...
    <form method="post" action="editbasketball.php">
        <div class="form-group">
            <label for="basketball">Basketball:</label>
            <input type="number" name="basketball" id="basketball" value="<?php echo $row['basketball']; ?>">
        </div>
