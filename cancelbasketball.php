...
if (isset($_POST["cancel_booking"])) {
    ...
    // Check if booking exists for the provided user ID and basketball item
    $sqlCheckBooking = "SELECT quantity FROM booking_list WHERE item = 'Basketball' AND id = ?";
    ...
    if (mysqli_stmt_num_rows($stmtCheckBooking) > 0) {
        ...
        $sqlDeleteBooking = "DELETE FROM booking_list WHERE item = 'Basketball' AND id = ?";
        ...
        $sqlUpdateInventory = "UPDATE inventory SET basketball = basketball + ?";
...
<body>
    <div class="container">
        <h2>Cancel Basketball Booking</h2>
