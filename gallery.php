    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                ...
                <!--<a href="" class="btn btn-light py-md-3 px-md-5">Remove Picture <br> (for admin)</a>-->
            </div>
        </div>
    </div>
    <!-- Hero End -->
...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        // Your SQL query to fetch image data from the database
        $sql = "SELECT * FROM gallery";

        // Execute the SQL query and fetch results (make sure you have a database connection established)
        $result = $conn->query($sql);

        // Loop through the fetched images and display them
        while ($row = $result->fetch_assoc()) {

        // Sample code for displaying images (replace with your HTML structure)
        ...
        $conn->close(); // Uncomment this line when you have a database connection
        ?>
    </div>
</div>
<!-- Gallery End -->
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    <div class="position-relative overflow-hidden rounded">
                        <img class="img-fluid w-100" src="img\gallery\football_1.jpg" alt="">
                        <!--<div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square rounded-circle mx-1" href="https://www.facebook.com/SCUIU/photos"><i class="fab fa-facebook-f"></i></a>
                            </div>
                        </div>-->
                    </div>
                    <div class="position-center start-0 bottom-5 w-20 rounded-bottom text-center p-3" style="background: rgba(34, 36, 41, .9);">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    <div class="position-relative overflow-hidden rounded">
                        <img class="img-fluid w-100" src="img\gallery\Cricket_1.jpg" alt="">
                        <!--<div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item position-relative">
                    <div class="position-relative overflow-hidden rounded">
                        <img class="img-fluid w-100" src="img\gallery\Indoor_1.jpg" alt="">
                        <!--<div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square rounded-circle mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-light btn-square rounded-circle mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="team-item position-relative">
                        <div class="position-relative overflow-hidden rounded">
                            <img class="img-fluid w-100" src="img\gallery\football_2.jpg" alt="">
                            <!--<div class="team-overlay">
                                <div class="d-flex align-items-center justify-content-start">
                                    <a class="btn btn-light btn-square rounded-circle mx-1" href="https://www.facebook.com/SCUIU/photos"><i class="fab fa-facebook-f"></i></a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-item position-relative">
                        <div class="position-relative overflow-hidden rounded">
                            <img class="img-fluid w-100" src="img\gallery\football_3.jpg" alt="">
                            <!--<div class="team-overlay">
                                <div class="d-flex align-items-center justify-content-start">
                                    <a class="btn btn-light btn-square rounded-circle mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-light btn-square rounded-circle mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-item position-relative">
                        <div class="position-relative overflow-hidden rounded">
                            <img class="img-fluid w-100" src="img\gallery\Indoor_2.jpg" alt="">
                            <!--<div class="team-overlay">
                                <div class="d-flex align-items-center justify-content-start">
                                    <a class="btn btn-light btn-square rounded-circle mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-light btn-square rounded-circle mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
