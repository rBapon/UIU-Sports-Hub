...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($quantity <= $availableInventory) {
        ...
        if (mysqli_stmt_execute($stmtInsertBooking)) {
            ...
            $sqlUpdateInventory = "UPDATE inventory SET cricket_ball = ?";
...
<body>
    ...
    ?>
    <!-- Booking form -->
    <form method="post" action="bookcricketball.php">
